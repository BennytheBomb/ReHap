...
namespace Uralstech.UXR.QuestCamera
{
    ...
    public class CaptureSessionObject<T> where T : ContinuousCaptureSession
    {
        ...
        /// </summary>
        public readonly YUVToGrayscaleConverter TextureConverter;
        ...
        internal CaptureSessionObject(GameObject gameObject, T captureSession, CameraFrameForwarder cameraFrameForwarder)
        // internal CaptureSessionObject(GameObject gameObject, T captureSession, YUVToGrayscaleConverter textureConverter, CameraFrameForwarder cameraFrameForwarder)
        {
