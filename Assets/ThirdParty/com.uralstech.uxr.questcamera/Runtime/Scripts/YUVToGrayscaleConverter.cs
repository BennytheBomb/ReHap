...
namespace Uralstech.UXR.QuestCamera
{
    ...
    /// </summary>
    public class YUVToGrayscaleConverter : MonoBehaviour
    {
        /// <summary>
...
#pragma warning restore IDE1006 // Naming Styles
        ...
        public virtual void SetupCameraFrameForwarder(CameraFrameForwarder cameraFrameForwarder, Resolution textureResolution)
        {
                ...
                || FrameRenderTexture.height != textureResolution.height)
            {
                ...
                FrameRenderTexture = new RenderTexture(textureResolution.width, textureResolution.height, 0, RenderTextureFormat.R8)
                {
            ...
            long timestamp)
        {
            ...
            SendFrameToComputeBuffer(yRowStride, timestamp);
        ...
        protected virtual async void SendFrameToComputeBuffer(int yRowStride, long timestampNs)
        {
#if UNITY_6000_0_OR_NEWER
            await Awaitable.MainThreadAsync();
#elif UTILITIES_ASYNC
            ...
            Shader.SetTexture(kernelHandle, "OutputR", FrameRenderTexture);
